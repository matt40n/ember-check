...
export const SNAPSHOTS = {
  forests: `https://apps.fs.usda.gov/arcx/rest/services/EDW/EDW_ForestSystemBoundaries_01/MapServer/0/query?where=REGION%20IN%20(%2705%27,%2704%27)&geometry=-124.5,36.5,-118,42.1&geometryType=esriGeometryEnvelope&inSR=4326&spatialRel=esriSpatialRelIntersects&outFields=forestname&outSR=4326&geometryPrecision=4&f=geojson`,
  ...
  nps: `https://services1.arcgis.com/fBc8EJBxQRMcHlei/arcgis/rest/services/NPS_Land_Resources_Division_Boundary_and_Tract_Data_Service/FeatureServer/2/query?where=STATE%20LIKE%20%27CA%25%27&outFields=UNIT_NAME,UNIT_CODE,UNIT_TYPE&geometryPrecision=4&maxAllowableOffset=0.0004&geometry=-124.5,36.5,-118,42.1&geometryType=esriGeometryEnvelope&inSR=4326&spatialRel=esriSpatialRelIntersects&outSR=4326&f=geojson`,
