...
export const JURISDICTIONS: Jurisdiction[] = [
  ...
  {
    id: 'usfs-klamath', pageFireHash: 'v5:1j1z3c5:q9', noticeUpdated: '2026-09-09', developedSitesListed: ['Curly Jack Campground', 'Grider Creek Campground', 'Norcross Trailhead', 'Sarah Totten Campground', 'Sulphur Springs Campground', 'Beaver Creek Campground', 'Grouse Gap Shelter', 'Mount Ashland Campground', 'Tree of Heaven Campground', 'Carter Meadows Group Campground', 'Hidden Horse Campground', 'Idlewild Campground', 'Indian Scotty Campground', 'Jones Beach Picnic Area', 'Kangaroo Lake Campground and Picnic Area', 'Trail Creek Campground', 'Juanita Lake Day Use Area, Campground, and Group Site', 'Martin\'s Dairy Campground', 'Martin\'s Dairy Horse Campground', 'Orr Lake Campground', 'Shafter Campground'], developedSitesComplete: true, boundary: { source: 'usfs', match: 'Klamath National Forest' }, wildernessExempt: ['Trinity Alps Wilderness', 'Siskiyou Wilderness', 'Marble Mountain Wilderness', 'Russian Wilderness'], wildernessNote: 'Order 05-05-00-26-11 (Sep 9) added these four wilderness exemptions; the earlier order had none. A CA Campfire Permit is still required statewide.', name: 'Klamath NF', agency: 'USFS', lat: 41.6, lng: -123.0, radiusKm: 60,
    stage: 'stage1', campfiresDeveloped: 'allowed', campfiresDispersed: 'prohibited', stoves: 'allowed_with_permit', smoking: 'prohibited',
    effective: '2026-09-09', expires: '2026-10-30', orderNumber: '05-05-00-26-11',
    sourceUrl: 'https://www.fs.usda.gov/r05/klamath/alerts/fire-restrictions-effect-klamath-national-forest',
    notes: 'Order 05-05-00-26-11 (Sep 9 – Oct 30, 2026) supersedes 26-07: same 21 Exhibit A sites (no permit needed there), and campfires are now allowed in Trinity Alps, Siskiyou, Marble Mountain and Russian Wildernesses. Elsewhere, permit holders may use gas/pressurized-fuel stoves and lanterns with a shut-off valve, 5 ft from flammables. Ukonom RD inside this boundary is Six Rivers-managed and follows the Six Rivers order.', verifiedOn: '2026-09-21',
  },
  {
  ...
  // ───────────── BLM California ─────────────
  {
    ...
    notes: 'Campfires only at Shasta, Bohemotash, Ohl Olsen, Junction City, Steel Bridge, Douglas City and Reading Island sites; none in Butte County. Chainsaws until 1 pm; target shooting until noon.', verifiedOn: '2026-09-21',
  },
  {
    ...
    notes: 'Wood fires only in agency rings at developed sites. Applies to the Lost Coast Trail — no beach fires.', verifiedOn: '2026-09-21',
  },
  {
    ...
    notes: 'No campfires or open flame even in established campgrounds. Target shooting banned. Covers BLM portions of Berryessa Snow Mountain NM.', verifiedOn: '2026-09-21',
  },
  {
  ...
  },
  {
    ...
    notes: "Signed order CAC09000-26-06 bans campfires and open flame of any kind — including in developed campgrounds; the press release reads looser than the order. Gas stoves OK with a CA Campfire Permit. Inyo, Mono and part of Alpine counties. Target shooting banned.", verifiedOn: '2026-09-21',
  },
