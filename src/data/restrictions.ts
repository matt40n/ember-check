 ...
 */
export const DATA_VERIFIED_ON = '2026-09-19'
...
export const JURISDICTIONS: Jurisdiction[] = [
  ...
  },
  {
    ...
    notes: 'Order 05-05-00-26-11 (Sep 9 – Oct 30, 2026) supersedes 26-07: same 21 Exhibit A sites (no permit needed there), and campfires are now allowed in Trinity Alps, Siskiyou, Marble Mountain and Russian Wildernesses. Elsewhere, permit holders may use gas/pressurized-fuel stoves and lanterns with a shut-off valve, 5 ft from flammables. Ukonom RD inside this boundary is Six Rivers-managed and follows the Six Rivers order.', verifiedOn: '2026-09-19',
  },
  {
    ...
    notes: 'Campfires allowed with a CA Campfire Permit in the six wilderness areas (incl. Marble Mountain via Ukonom RD) and at Designated Fire Safe Sites. Exhibit A updated Aug 20, 2026: Patrick Creek, Grassy Flat, Boise Creek and East Fork campgrounds were removed — no campfires there now.', verifiedOn: '2026-09-19',
  },
  {
    ...
    notes: 'With a permit: campfires at Exhibit A fire-safe sites and inside Yolla Bolly, Snow Mountain, Yuki and Sanhedrin Wildernesses.', verifiedOn: '2026-09-19',
  },
  {
    ...
    notes: 'Campfires still allowed in the South Warner Wilderness. Alert page says Nov 3; the signed order says Oct 31.', verifiedOn: '2026-09-19',
  },
  {
    ...
    notes: 'Wood fires with a permit only at the Exhibit A campgrounds (transcribed) and in federally designated wilderness (Caribou, Thousand Lakes, Ishi — the order references an Exhibit B map that is not published). Forest says it will consider early rescission after fall moisture.', verifiedOn: '2026-09-19',
  },
  {
  ...
  },
  {
    ...
    notes: 'Stage 2: wood fires only in rings at campgrounds maintained by a host. Gas stove/lantern with shutoff OK with permit, 3 ft clearance.', verifiedOn: '2026-09-19',
  },
  {
  ...
  },
  {
    ...
    notes: 'Permanent order: wood fires only in installed rings at 17 listed campgrounds. Never in Desolation Wilderness, Meiss Country, along the PCT/TRT, beaches or general forest. Local fire districts add their own bans.', verifiedOn: '2026-09-19',
  },
  {
  ...
  },
  {
    ...
    notes: 'Campfires still allowed inside designated wilderness, except above 10,000 ft (north) / 10,400 ft (south) in Ansel Adams and John Muir (order 05-15-00-26-09).', verifiedOn: '2026-09-19',
  },
  {
    ...
    notes: 'Charcoal banned outside Exhibit A sites. Permanent wilderness elevation bans (no fires above ~10,000 ft in John Muir/Ansel Adams) remain. Rock Fire area closure through Dec 31.', verifiedOn: '2026-09-19',
  },
  {
    ...
    notes: 'No chainsaws or engine tools 1 pm–1 am. CA Campfire Permit required on the California side.', verifiedOn: '2026-09-19',
  },
  {
    ...
    notes: 'Hoover Wilderness: no dispersed fires under Stage 1.', verifiedOn: '2026-09-19',
  },
  ...
  // ───────────── BLM California ─────────────
  {
    ...
    notes: 'Campfires only at Shasta, Bohemotash, Ohl Olsen, Junction City, Steel Bridge, Douglas City and Reading Island sites; none in Butte County. Chainsaws until 1 pm; target shooting until noon.', verifiedOn: '2026-09-19',
  },
  {
    ...
    notes: 'Wood fires only in agency rings at developed sites. Applies to the Lost Coast Trail — no beach fires.', verifiedOn: '2026-09-19',
  },
  {
    ...
    notes: 'No campfires or open flame even in established campgrounds. Target shooting banned. Covers BLM portions of Berryessa Snow Mountain NM.', verifiedOn: '2026-09-19',
  },
  {
    ...
    notes: 'Campfires only at N. Eagle Lake CG, Hobo Camp, Fort Sage OHV, Dodge Reservoir CG, Ramhorn Springs CG and Rice Canyon OHV.', verifiedOn: '2026-09-19',
  },
  {
    ...
    notes: 'Campfires only at Pit River and Boulder Reservoir recreation sites. No vehicles off established roads.', verifiedOn: '2026-09-19',
  },
  {
    ...
    notes: 'No campfire or open flame of any kind. Target shooting banned. Sierra foothills from Yuba/Nevada to Mariposa incl. Merced River, Cosumnes, South Yuba.', verifiedOn: '2026-09-19',
  },
  {
    ...
    notes: "Signed order CAC09000-26-06 bans campfires and open flame of any kind — including in developed campgrounds; the press release reads looser than the order. Gas stoves OK with a CA Campfire Permit. Inyo, Mono and part of Alpine counties. Target shooting banned.", verifiedOn: '2026-09-19',
  },
  ...
  // ───────────── National Park Service ─────────────
  {
    ...
    notes: 'Stage 2 applies below 8,000 ft. Between 8,000 and 9,600 ft: existing rings only, 100 ft from water/trail. Never above 9,600 ft. Twig stoves banned; gas/alcohol/tablet stoves OK.', verifiedOn: '2026-09-19',
  },
  {
  ...
  },
  {
    ...
    notes: 'Closure Order 26-001 (Jul 31, 2026) banned all wood/charcoal fires; the park conditions page now says: "Effective Sept. 2, 2026 - No fire restrictions are in place in the campground." Fires in Indian Well Campground rings only — no fires elsewhere in the monument; gas stoves OK.', verifiedOn: '2026-09-19',
  },
  {
    ...
    notes: 'No 2026 park-wide order posted as of Aug 28. Campground rings normally OK; backcountry fires often banned late summer. Call 707-464-6101.', verifiedOn: '2026-09-19',
  },
  {
    ...
    notes: 'Park alert "Wood & Charcoal Burn Ban": wood and charcoal/briquette burning is temporarily banned during the hot, dry season — campground rings and grills included. Propane grills and gas stoves OK. The alert shows at the top of every park page.', verifiedOn: '2026-09-19',
  },
  {
    ...
    notes: 'Beach fires only, with a free permit, below the high-tide line, 30 ft from vegetation, out by 10 pm; not on Drakes Beach. Suspended on any High fire-danger day — call 415-464-5100. No wood fires at backcountry camps.', verifiedOn: '2026-09-19',
  },
  ...
  // ───────────── State Parks ─────────────
  {
    ...
    notes: 'Campfires, wood/charcoal cooking and liquid-fuel torches prohibited for the rest of the 2026 season. Other state parks: no statewide order — fires only in provided rings; check each park.', verifiedOn: '2026-09-19',
  },
  {
    ...
    notes: 'Gold Fields District has banned all campfires here every summer (2025 order 690-058). 2026 order not located — assume banned until the district confirms.', verifiedOn: '2026-09-19',
  },
]
