 ...
 */
export const DATA_VERIFIED_ON = '2026-09-13'
...
export const JURISDICTIONS: Jurisdiction[] = [
  ...
  },
  {
    ...
    notes: 'Charcoal banned outside Exhibit A sites. Permanent wilderness elevation bans (no fires above ~10,000 ft in John Muir/Ansel Adams) remain. Rock Fire area closure through Dec 31.', verifiedOn: '2026-09-13',
  },
  {
    id: 'usfs-htnf-carson', pageFireHash: 'v4:g9yua:14b', developedSitesRule: 'any_developed', noticeUpdated: '2026-06-29', boundary: { source: 'usfs', match: 'Humboldt-Toiyabe National Forest' }, name: 'Humboldt-Toiyabe — Carson RD', agency: 'USFS', lat: 38.7, lng: -119.8, radiusKm: 35,
    stage: 'stage1', campfiresDeveloped: 'allowed', campfiresDispersed: 'prohibited', stoves: 'allowed_with_permit', smoking: 'prohibited',
    ...
    notes: 'No chainsaws or engine tools 1 pm–1 am. CA Campfire Permit required on the California side.', verifiedOn: '2026-09-13',
  },
  {
    id: 'usfs-htnf-bridgeport', pageFireHash: 'v4:jlhnio:28a', developedSitesRule: 'any_developed', noticeUpdated: '2026-06-30', name: 'Humboldt-Toiyabe — Bridgeport RD', agency: 'USFS', lat: 38.2, lng: -119.4, radiusKm: 35,
    stage: 'stage1', campfiresDeveloped: 'allowed', campfiresDispersed: 'prohibited', stoves: 'allowed_with_permit', smoking: 'prohibited',
  ...
  // ───────────── BLM California ─────────────
  {
    ...
    notes: 'Campfires only at Shasta, Bohemotash, Ohl Olsen, Junction City, Steel Bridge, Douglas City and Reading Island sites; none in Butte County. Chainsaws until 1 pm; target shooting until noon.', verifiedOn: '2026-09-13',
  },
  {
    id: 'blm-arcata', pageFireHash: 'v4:1y3l676:zu', checkUrl: 'https://www.blm.gov/announcement/blm-announces-seasonal-fire-restrictions-north-coast-public-lands-0', orderNumber: 'CA-330-26-01', developedSitesRule: 'any_developed', noticeUpdated: '2026-06-28', boundary: { source: 'blm', match: 'Arcata Field Office' }, name: 'BLM Arcata Field Office (King Range / Lost Coast)', agency: 'BLM', lat: 40.2, lng: -124.0, radiusKm: 45,
    stage: 'stage1', campfiresDeveloped: 'allowed', campfiresDispersed: 'prohibited', stoves: 'allowed_with_permit', smoking: 'prohibited',
    effective: '2026-06-28', expires: 'until_rescinded',
    sourceUrl: 'https://www.blm.gov/sites/default/files/docs/2026-06/BLM-CA-ArcataFO-Fire-Restrictions-2026_508.pdf',
    notes: 'Wood fires only in agency rings at developed sites. Applies to the Lost Coast Trail — no beach fires.', verifiedOn: '2026-09-13',
  },
  {
    id: 'blm-ukiah', pageFireHash: 'v4:10hreso:u2', noticeUpdated: '2026-06-05', boundary: { source: 'blm', match: 'Ukiah Field Office' }, name: 'BLM Ukiah Field Office (Cow Mtn, Cache Creek)', agency: 'BLM', lat: 39.1, lng: -122.9, radiusKm: 45,
    ...
    notes: 'No campfires or open flame even in established campgrounds. Target shooting banned. Covers BLM portions of Berryessa Snow Mountain NM.', verifiedOn: '2026-09-13',
  },
  {
    id: 'blm-eagle-lake', pageFireHash: 'v4:ejc6b3:a4p', checkUrl: 'https://www.blm.gov/programs/public-safety-and-fire/fire-and-aviation/regional-info/california/fire-restrictions', developedSitesListed: ['North Eagle Lake Campground', 'Hobo Camp Day Use Area', 'Fort Sage Off-Highway Vehicle Area', 'Dodge Reservoir Campground', 'Ramhorn Springs Campground', 'Rice Canyon Off-Highway Vehicle Area'], developedSitesComplete: true, noticeUpdated: '2026-07-14', boundary: { source: 'blm', match: 'Eagle Lake Field Office' }, name: 'BLM Eagle Lake Field Office', agency: 'BLM', lat: 40.6, lng: -120.5, radiusKm: 45,
    stage: 'stage1', campfiresDeveloped: 'allowed', campfiresDispersed: 'prohibited', stoves: 'allowed_with_permit', smoking: 'prohibited',
    ...
    notes: 'Campfires only at N. Eagle Lake CG, Hobo Camp, Fort Sage OHV, Dodge Reservoir CG, Ramhorn Springs CG and Rice Canyon OHV.', verifiedOn: '2026-09-13',
  },
  {
    id: 'blm-applegate', pageFireHash: 'v4:ejc6b3:a4p', checkUrl: 'https://www.blm.gov/programs/public-safety-and-fire/fire-and-aviation/regional-info/california/fire-restrictions', developedSitesListed: ['Pit River', 'Boulder Reservoir'], developedSitesComplete: true, noticeUpdated: '2026-07-14', boundary: { source: 'blm', match: 'Applegate Field Office' }, name: 'BLM Applegate Field Office (Alturas)', agency: 'BLM', lat: 41.5, lng: -120.5, radiusKm: 45,
    stage: 'stage1', campfiresDeveloped: 'allowed', campfiresDispersed: 'prohibited', stoves: 'allowed_with_permit', smoking: 'prohibited',
    ...
    notes: 'Campfires only at Pit River and Boulder Reservoir recreation sites. No vehicles off established roads.', verifiedOn: '2026-09-13',
  },
  {
    id: 'blm-mother-lode', pageFireHash: 'v4:ejc6b3:a4p', checkUrl: 'https://www.blm.gov/programs/public-safety-and-fire/fire-and-aviation/regional-info/california/fire-restrictions', noticeUpdated: '2026-05-15', boundary: { source: 'blm', match: 'Mother Lode Field Office' }, name: 'BLM Mother Lode Field Office', agency: 'BLM', lat: 38.5, lng: -120.6, radiusKm: 55,
    stage: 'stage2', campfiresDeveloped: 'prohibited', campfiresDispersed: 'prohibited', stoves: 'allowed_with_permit', smoking: 'prohibited',
    ...
    notes: 'No campfire or open flame of any kind. Target shooting banned. Sierra foothills from Yuba/Nevada to Mariposa incl. Merced River, Cosumnes, South Yuba.', verifiedOn: '2026-09-13',
  },
  {
    id: 'blm-bishop', pageFireHash: 'v4:10r3c67:151', checkUrl: 'https://www.blm.gov/announcement/blm-announces-seasonal-fire-restrictions-eastern-sierra-0', noticeUpdated: '2026-06-22', boundary: { source: 'blm', match: 'Bishop Field Office' }, name: 'BLM Bishop Field Office', agency: 'BLM', lat: 37.6, lng: -118.4, radiusKm: 50,
    stage: 'stage2', campfiresDeveloped: 'prohibited', campfiresDispersed: 'prohibited', stoves: 'allowed_with_permit', smoking: 'prohibited',
    ...
    notes: "Signed order CAC09000-26-06 bans campfires and open flame of any kind — including in developed campgrounds; the press release reads looser than the order. Gas stoves OK with a CA Campfire Permit. Inyo, Mono and part of Alpine counties. Target shooting banned.", verifiedOn: '2026-09-13',
  },

  // ───────────── National Park Service ─────────────
  {
    id: 'nps-yosemite', pageFireHash: 'v4:ac8ozh:2ai', developedSitesRule: 'any_developed', noticeUpdated: '2026-08-02', boundary: { source: 'nps', match: 'Yosemite National Park' }, name: 'Yosemite NP', agency: 'NPS', lat: 37.85, lng: -119.55, radiusKm: 45,
    ...
    notes: 'Stage 2 applies below 8,000 ft. Between 8,000 and 9,600 ft: existing rings only, 100 ft from water/trail. Never above 9,600 ft. Twig stoves banned; gas/alcohol/tablet stoves OK.', verifiedOn: '2026-09-13',
  },
  {
    id: 'nps-lassen-volcanic', pageFireHash: 'v4:1wg7cot:a7', noticeUpdated: '2026-07-30', boundary: { source: 'nps', match: 'Lassen Volcanic National Park' }, name: 'Lassen Volcanic NP', agency: 'NPS', lat: 40.5, lng: -121.45, radiusKm: 20,
    ...
    notes: 'No wood or charcoal fires in any campground. Self-contained propane/petroleum stoves and lanterns OK.', verifiedOn: '2026-09-13',
  },
  {
    id: 'nps-lava-beds', pageFireHash: 'v4:1fft04j:6n', confidence: 'medium', confidenceNote: 'Lifting is stated on the conditions page only; no formal rescission notice found. Call 530-667-8113 to confirm.', noticeUpdated: '2026-09-02', boundary: { source: 'nps', match: 'Lava Beds National Monument' }, name: 'Lava Beds NM', agency: 'NPS', lat: 41.75, lng: -121.5, radiusKm: 15,
    ...
    notes: 'Closure Order 26-001 (Jul 31, 2026) banned all wood/charcoal fires; the park conditions page now says: "Effective Sept. 2, 2026 - No fire restrictions are in place in the campground." Fires in Indian Well Campground rings only — no fires elsewhere in the monument; gas stoves OK.', verifiedOn: '2026-09-13',
  },
  {
    id: 'nps-redwood', pageFireHash: 'v4:kdh5mk:3f', noticeUpdated: '2026-09-10', confidence: 'low', confidenceNote: 'No 2026 fire order found on nps.gov (conditions page edited Aug 31 and Sep 2, still no order; no fire alerts posted). Status is inferred, not confirmed.', boundary: { source: 'nps', match: 'Redwood National Park' }, name: 'Redwood National & State Parks', agency: 'NPS', lat: 41.3, lng: -124.0, radiusKm: 30,
  ...
  },
  {
    ...
    notes: 'Park has banned campfires each summer 2021–2025; a Recreation.gov note lists "gas stoves only" through Sep 1, 2026 but nps.gov shows no order. Call 530-242-3400.', verifiedOn: '2026-09-13',
  },
  {
    id: 'nps-point-reyes', pageFireHash: 'v4:10b5c7y:1uj', noticeUpdated: '2026-08-28', confidence: 'medium', confidenceNote: 'Beach-fire permits are suspended day-by-day on high fire-danger days — call 415-464-5100 the morning of.', boundary: { source: 'nps', match: 'Point Reyes National Seashore' }, name: 'Point Reyes NS', agency: 'NPS', lat: 38.07, lng: -122.88, radiusKm: 20,
    ...
    notes: 'Beach fires only, with a free permit, below the high-tide line, 30 ft from vegetation, out by 10 pm; not on Drakes Beach. Suspended on any High fire-danger day — call 415-464-5100. No wood fires at backcountry camps.', verifiedOn: '2026-09-13',
  },
  ...
  // ───────────── State Parks ─────────────
  {
    id: 'csp-folsom-peninsula', pageFireHash: 'v4:v715r0:95', name: 'Folsom Lake SRA — Peninsula CG', agency: 'State Parks', lat: 38.75, lng: -121.1, radiusKm: 8,
    ...
    notes: 'Campfires, wood/charcoal cooking and liquid-fuel torches prohibited for the rest of the 2026 season. Other state parks: no statewide order — fires only in provided rings; check each park.', verifiedOn: '2026-09-13',
  },
  {
    id: 'csp-auburn', pageFireHash: 'v4:1je2vd6:tj', confidence: 'low', confidenceNote: '2026 district order not located; based on the pattern of prior years.', name: 'Auburn SRA', agency: 'State Parks', lat: 38.92, lng: -121.0, radiusKm: 12,
    stage: 'unknown', campfiresDeveloped: 'unknown', campfiresDispersed: 'prohibited', stoves: 'allowed', smoking: 'unknown',
    expires: 'until_rescinded',
    sourceUrl: 'https://www.parks.ca.gov/?page_id=502',
    notes: 'Gold Fields District has banned all campfires here every summer (2025 order 690-058). 2026 order not located — assume banned until the district confirms.', verifiedOn: '2026-09-13',
  },
]
