...
export const JURISDICTIONS: Jurisdiction[] = [
  ...
  },
  {
    ...
    notes: 'Campfires allowed with a CA Campfire Permit in the six wilderness areas (incl. Marble Mountain via Ukonom RD) and at Designated Fire Safe Sites. Exhibit A updated Aug 20, 2026: Patrick Creek, Grassy Flat, Boise Creek and East Fork campgrounds were removed — no campfires there now.', verifiedOn: V,
  },
  {
    ...
    notes: 'With a permit: campfires at Exhibit A fire-safe sites and inside Yolla Bolly, Snow Mountain, Yuki and Sanhedrin Wildernesses.', verifiedOn: V,
  },
  {
    ...
    notes: 'Campfires still allowed in the South Warner Wilderness. Alert page says Nov 3; the signed order says Oct 31.', verifiedOn: V,
  },
  {
    ...
    notes: 'Wood fires with a permit only at the Exhibit A campgrounds (transcribed) and in federally designated wilderness (Caribou, Thousand Lakes, Ishi — the order references an Exhibit B map that is not published). Forest says it will consider early rescission after fall moisture.', verifiedOn: V,
  },
  {
    id: 'usfs-plumas', developedSitesListed: ['Big Cove Campground', 'Chilcoot Campground', 'Cottonwood Group Campground', 'Cottonwood Springs Campground', 'Frenchman Campground', 'Frenchman Picnic Area', 'Gold Lake Campground', 'Grasshopper Flat Campground', 'Grizzly Campground', 'Lakes Basin Campground', 'Lightning Tree Campground', 'Spring Creek Campground', 'Boulder Creek Campground', 'Gansner Bar Campground', 'Hallsted Campground', 'Lone Rock Campground', 'Long Point Campground', 'Long Point Group Campground', 'Mill Creek Campground', 'Queen Lily Campground', 'North Fork Campground', 'Sandy Point Day Use Area', 'Spanish Creek Campground', 'Sundew Campground', 'Cottage Creek Campground', 'Red Feather Campground'], developedSitesComplete: true, noticeUpdated: '2026-08-06', boundary: { source: 'usfs', match: 'Plumas National Forest' }, wildernessNote: 'Stage II: no fires in Bucks Lake Wilderness.', name: 'Plumas NF', agency: 'USFS', lat: 39.9, lng: -120.9, radiusKm: 50,
    ...
    notes: 'Stage II: wood fires ONLY in the Exhibit A campgrounds (transcribed) and only while a campground host is present; Sandy Point is BBQs only. No wilderness fires. Carry a shovel and water. Gas stoves with shutoff OK with permit.', verifiedOn: V,
  },
  {
  ...
  },
  {
    ...
    notes: 'Permanent order: wood fires only in installed rings at 17 listed campgrounds. Never in Desolation Wilderness, Meiss Country, along the PCT/TRT, beaches or general forest. Local fire districts add their own bans.', verifiedOn: V,
  },
  {
  ...
  },
  {
    ...
    notes: 'Charcoal banned outside Exhibit A sites. Permanent wilderness elevation bans (no fires above ~10,000 ft in John Muir/Ansel Adams) remain. Rock Fire area closure through Dec 31.', verifiedOn: V,
  },
  {
    ...
    notes: 'No chainsaws or engine tools 1 pm–1 am. CA Campfire Permit required on the California side.', verifiedOn: V,
  },
  {
  ...
  // ───────────── BLM California ─────────────
  {
    ...
    sourceUrl: 'https://www.blm.gov/announcement/blm-announces-seasonal-fire-restrictions-northwest-california-public-lands-0',
  ...
  },
  {
    ...
    stage: 'stage1', campfiresDeveloped: 'allowed', campfiresDispersed: 'prohibited', stoves: 'allowed_with_permit', smoking: 'prohibited',
    effective: '2026-06-28', expires: 'until_rescinded',
    sourceUrl: 'https://www.blm.gov/announcement/blm-announces-seasonal-fire-restrictions-north-coast-public-lands-0',
  ...
  },
  {
    ...
    notes: 'Campfires only at N. Eagle Lake CG, Hobo Camp, Fort Sage OHV, Dodge Reservoir CG, Ramhorn Springs CG and Rice Canyon OHV.', verifiedOn: V,
  },
  {
    ...
    notes: 'Campfires only at Pit River and Boulder Reservoir recreation sites. No vehicles off established roads.', verifiedOn: V,
  },
  {
    ...
    notes: 'No campfire or open flame of any kind. Target shooting banned. Sierra foothills from Yuba/Nevada to Mariposa incl. Merced River, Cosumnes, South Yuba.', verifiedOn: V,
  },
  {
    ...
    sourceUrl: 'https://www.blm.gov/announcement/blm-announces-seasonal-fire-restrictions-eastern-sierra-0',
  ...
  // ───────────── National Park Service ─────────────
  {
    ...
    notes: 'Stage 2 applies below 8,000 ft. Between 8,000 and 9,600 ft: existing rings only, 100 ft from water/trail. Never above 9,600 ft. Twig stoves banned; gas/alcohol/tablet stoves OK.', verifiedOn: V,
  },
  {
    ...
    notes: 'No wood or charcoal fires in any campground. Self-contained propane/petroleum stoves and lanterns OK.', verifiedOn: V,
  },
  {
    id: 'nps-lava-beds', noticeUpdated: '2026-07-31', confidence: 'medium', confidenceNote: 'Alert says all open flames prohibited; unclear whether gas stoves are included. Call 530-667-8113.', boundary: { source: 'nps', match: 'Lava Beds National Monument' }, name: 'Lava Beds NM', agency: 'NPS', lat: 41.75, lng: -121.5, radiusKm: 15,
    stage: 'full_ban', campfiresDeveloped: 'prohibited', campfiresDispersed: 'prohibited', stoves: 'unknown', smoking: 'unknown',
    ...
    notes: '"All open flames prohibited," including Indian Well Campground. Prior years allowed gas stoves — call 530-667-8113 to confirm.', verifiedOn: V,
  },
  {
    ...
    notes: 'No 2026 park-wide order posted as of Aug 28. Campground rings normally OK; backcountry fires often banned late summer. Call 707-464-6101.', verifiedOn: V,
  },
  {
  ...
  },
  {
    ...
    notes: 'Beach fires only, with a free permit, below the high-tide line, 30 ft from vegetation, out by 10 pm; not on Drakes Beach. Suspended on any High fire-danger day — call 415-464-5100. No wood fires at backcountry camps.', verifiedOn: V,
  },
