 ...
 */
export const DATA_VERIFIED_ON = '2026-09-24'
...
export const JURISDICTIONS: Jurisdiction[] = [
  // ───────────── USFS Region 5 ─────────────
  {
    ...
    notes: 'Ring fires only at the 89 Exhibit A developed sites (all districts transcribed) — free/undeveloped campgrounds like Gumboot are not listed, so no wood fires there. With a CA Campfire Permit, wood fires are also OK within 10 ft of Shasta Lake, Trinity Lake or Iron Canyon Res. (50 ft from vegetation), at Exhibit B fire-safe sites, and inside the Yolla Bolly, Chanchelulla, Castle Crags and Trinity Alps Wildernesses (not Mt. Shasta Wilderness). Smoking only in a vehicle/building or a 3-ft cleared spot. Separately, Order 14-26-06 (Jul 29, 2026 – Jul 29, 2027) bans camping and ALL fires and stoves outside developed sites in the Mt. Shasta Plantation area around Mount Shasta city — no campfire-permit exemption there.', verifiedOn: '2026-09-26',
  },
  {
    id: 'usfs-klamath', pageFireHash: 'v5:fbfjaf:ow', noticeUpdated: '2026-09-24', boundary: { source: 'usfs', match: 'Klamath National Forest' }, name: 'Klamath NF', agency: 'USFS', lat: 41.6, lng: -123.0, radiusKm: 60,
  ...
  },
  {
    ...
    notes: 'Stage 2: wood fires only in rings at campgrounds maintained by a host. Gas stove/lantern with shutoff OK with permit, 3 ft clearance.', verifiedOn: '2026-09-26',
  },
  {
    id: 'usfs-eldorado', pageFireHash: 'v5:16qelz9:py', developedSitesListed: ['Bear River Group Campground', 'Pardoes Point', 'Pipi', 'Caples Lake Campground', 'Caples Lake Boat Launch', 'Silver Lake East Campground', 'Kirkwood Lake', 'Camp Winton (Boy Scouts of America)', 'Kit Carson Lodge', 'Caples Lake Resort', 'Two-Sentinels Girl Scout Camp', 'Crystal Administrative Site', 'Ice House', 'Fashoda', 'Sunset', 'Wench Creek', 'Wolf Creek', 'Yellowjacket Campground', 'Mountain Camp II', 'West Point', 'Gerle Creek', 'Loon Lake', 'Red Fir Group Campground', 'Northshore Campground', 'Wrights Lake', 'Deer Crossing Wilderness Camp', 'Power Pines Camp', 'Lover\'s Leap', 'Bridal Veil', 'Sand Flat Campground', 'China Flat Campground', 'Silver Fork Campground', 'Sly Park Education Center', 'Camp Sacramento', 'Sierra Pines Camp'], developedSitesComplete: true, noticeUpdated: '2026-09-23', boundary: { source: 'usfs', match: 'Eldorado National Forest' }, wildernessNote: 'No fires in Desolation or Mokelumne Wilderness.', name: 'Eldorado NF', agency: 'USFS', lat: 38.8, lng: -120.3, radiusKm: 45,
    stage: 'stage2', campfiresDeveloped: 'allowed', campfiresDispersed: 'prohibited', stoves: 'allowed_with_permit', smoking: 'prohibited',
    effective: '2026-08-20', expires: '2026-11-29', orderNumber: '03-26-07',
    sourceUrl: 'https://www.fs.usda.gov/r05/eldorado/alerts/fire-restrictions-are-effect-forest-wide',
    notes: 'Order 03-26-07 (signed Sep 22, 2026; supersedes 03-26-06) keeps the Aug 20 – Nov 29 window but drops six sites from Exhibit A: South Shore and Woods Lake (Amador RD) and all four Georgetown RD sites (Black Oak, Big Meadows, Stumpy Meadows, Ponderosa Cove) — no wood or charcoal fires there now. The alert adds that the ring must be at a site actively serviced by a camp host. Charcoal only in grills provided at Exhibit A sites. The exhibit bundles facilities under one name (e.g. Ice House: campground, boat ramp, day use) so all rings at that complex qualify. No wilderness exemption (Desolation never allows wood fires).', verifiedOn: V,
  },
  {
    id: 'usfs-ltbmu', pageFireHash: 'v5:1ktm0bg:1ou', developedSitesListed: ['Berkeley Camp', 'Blackwood Campground', 'Camp Concord', 'Camp Richardson Resort Campgrounds', 'Camp Richardson Stables', 'Camp Shelly', 'Fallen Leaf Campground', 'Kaspian Campground', 'Luther Campground', 'Meeks Bay Campground', 'Meeks Bay Resort and Campground', 'Nevada Beach Campground', 'Nevada Beach Day Use Area', 'Zephyr Cove Resort Campground', 'Watson Lake Campground', 'William Kent Campground', 'William Kent Day Use Area'], developedSitesComplete: true, noticeUpdated: '2026-09-11', confidence: 'medium', confidenceNote: 'Permanent 2024 order (page refreshed Aug 20, 2026; no new 2026 order), but local fire districts around the lake issue their own bans.', boundary: { source: 'usfs', match: 'Lake Tahoe Basin Management Unit' }, wildernessNote: 'Desolation Wilderness: never any wood fires.', name: 'Lake Tahoe Basin', agency: 'USFS', lat: 39.0, lng: -120.05, radiusKm: 30,
  ...
  },
  {
    ...
    notes: 'Charcoal banned outside Exhibit A sites. Permanent wilderness elevation bans (no fires above ~10,000 ft in John Muir/Ansel Adams) remain. Rock Fire area closure through Dec 31.', verifiedOn: '2026-09-24',
  },
  {
    id: 'usfs-htnf-carson', pageFireHash: 'v5:s9ntmd:uk', developedSitesRule: 'any_developed', noticeUpdated: '2026-06-29', boundary: { source: 'usfs', match: 'Humboldt-Toiyabe National Forest' }, name: 'Humboldt-Toiyabe — Carson RD', agency: 'USFS', lat: 38.7, lng: -119.8, radiusKm: 35,
    stage: 'stage1', campfiresDeveloped: 'allowed', campfiresDispersed: 'prohibited', stoves: 'allowed_with_permit', smoking: 'prohibited',
    ...
    notes: 'No chainsaws or engine tools 1 pm–1 am. CA Campfire Permit required on the California side.', verifiedOn: '2026-09-26',
  },
  {
    id: 'usfs-htnf-bridgeport', pageFireHash: 'v5:l37i9g:24q', developedSitesRule: 'any_developed', noticeUpdated: '2026-06-30', name: 'Humboldt-Toiyabe — Bridgeport RD', agency: 'USFS', lat: 38.2, lng: -119.4, radiusKm: 35,
    stage: 'stage1', campfiresDeveloped: 'allowed', campfiresDispersed: 'prohibited', stoves: 'allowed_with_permit', smoking: 'prohibited',
  ...
  // ───────────── BLM California ─────────────
  {
    ...
    notes: 'Campfires only at Shasta, Bohemotash, Ohl Olsen, Junction City, Steel Bridge, Douglas City and Reading Island sites; none in Butte County. Chainsaws until 1 pm; target shooting until noon.', verifiedOn: '2026-09-26',
  },
  {
    id: 'blm-arcata', statusHash: 's1:blm:v5:tzvvor:r6', pageFireHash: 'v5:1m1h2av:zw', checkUrl: 'https://www.blm.gov/announcement/blm-announces-seasonal-fire-restrictions-north-coast-public-lands-0', orderNumber: 'CA-330-26-01', developedSitesRule: 'any_developed', noticeUpdated: '2026-06-28', boundary: { source: 'blm', match: 'Arcata Field Office' }, name: 'BLM Arcata Field Office (King Range / Lost Coast)', agency: 'BLM', lat: 40.2, lng: -124.0, radiusKm: 45,
    stage: 'stage1', campfiresDeveloped: 'allowed', campfiresDispersed: 'prohibited', stoves: 'allowed_with_permit', smoking: 'prohibited',
    effective: '2026-06-28', expires: 'until_rescinded',
    sourceUrl: 'https://www.blm.gov/sites/default/files/docs/2026-06/BLM-CA-ArcataFO-Fire-Restrictions-2026_508.pdf',
    notes: 'Wood fires only in agency rings at developed sites. Applies to the Lost Coast Trail — no beach fires.', verifiedOn: '2026-09-26',
  },
  {
    id: 'blm-ukiah', statusHash: 's1:blm:v5:5s1nss:iy', pageFireHash: 'v5:13djqfu:u9', noticeUpdated: '2026-06-05', boundary: { source: 'blm', match: 'Ukiah Field Office' }, name: 'BLM Ukiah Field Office (Cow Mtn, Cache Creek)', agency: 'BLM', lat: 39.1, lng: -122.9, radiusKm: 45,
    ...
    notes: 'No campfires or open flame even in established campgrounds. Target shooting banned. Covers BLM portions of Berryessa Snow Mountain NM.', verifiedOn: '2026-09-26',
  },
  {
    id: 'blm-eagle-lake', statusHash: 's1:blm:v5:1omywee:b0', pageFireHash: 'v5:ejc6b3:a4p', checkUrl: 'https://www.blm.gov/programs/public-safety-and-fire/fire-and-aviation/regional-info/california/fire-restrictions', developedSitesListed: ['North Eagle Lake Campground', 'Hobo Camp Day Use Area', 'Fort Sage Off-Highway Vehicle Area', 'Dodge Reservoir Campground', 'Ramhorn Springs Campground', 'Rice Canyon Off-Highway Vehicle Area'], developedSitesComplete: true, noticeUpdated: '2026-07-14', boundary: { source: 'blm', match: 'Eagle Lake Field Office' }, name: 'BLM Eagle Lake Field Office', agency: 'BLM', lat: 40.6, lng: -120.5, radiusKm: 45,
    stage: 'stage1', campfiresDeveloped: 'allowed', campfiresDispersed: 'prohibited', stoves: 'allowed_with_permit', smoking: 'prohibited',
    ...
    notes: 'Campfires only at N. Eagle Lake CG, Hobo Camp, Fort Sage OHV, Dodge Reservoir CG, Ramhorn Springs CG and Rice Canyon OHV.', verifiedOn: '2026-09-26',
  },
  {
    id: 'blm-applegate', statusHash: 's1:blm:v5:1omywee:b0', pageFireHash: 'v5:ejc6b3:a4p', checkUrl: 'https://www.blm.gov/programs/public-safety-and-fire/fire-and-aviation/regional-info/california/fire-restrictions', developedSitesListed: ['Pit River', 'Boulder Reservoir'], developedSitesComplete: true, noticeUpdated: '2026-07-14', boundary: { source: 'blm', match: 'Applegate Field Office' }, name: 'BLM Applegate Field Office (Alturas)', agency: 'BLM', lat: 41.5, lng: -120.5, radiusKm: 45,
    stage: 'stage1', campfiresDeveloped: 'allowed', campfiresDispersed: 'prohibited', stoves: 'allowed_with_permit', smoking: 'prohibited',
    ...
    notes: 'Campfires only at Pit River and Boulder Reservoir recreation sites. No vehicles off established roads.', verifiedOn: '2026-09-26',
  },
  {
    id: 'blm-mother-lode', statusHash: 's1:blm:v5:tzvq9u:z2', pageFireHash: 'v5:ejc6b3:a4p', checkUrl: 'https://www.blm.gov/programs/public-safety-and-fire/fire-and-aviation/regional-info/california/fire-restrictions', noticeUpdated: '2026-05-15', boundary: { source: 'blm', match: 'Mother Lode Field Office' }, name: 'BLM Mother Lode Field Office', agency: 'BLM', lat: 38.5, lng: -120.6, radiusKm: 55,
    stage: 'stage2', campfiresDeveloped: 'prohibited', campfiresDispersed: 'prohibited', stoves: 'allowed_with_permit', smoking: 'prohibited',
    ...
    notes: 'No campfire or open flame of any kind. Target shooting banned. Sierra foothills from Yuba/Nevada to Mariposa incl. Merced River, Cosumnes, South Yuba.', verifiedOn: '2026-09-26',
  },
  {
    id: 'blm-bishop', statusHash: 's1:blm:v5:a4saie:p3', pageFireHash: 'v5:12uiz25:158', checkUrl: 'https://www.blm.gov/announcement/blm-announces-seasonal-fire-restrictions-eastern-sierra-0', noticeUpdated: '2026-06-22', boundary: { source: 'blm', match: 'Bishop Field Office' }, name: 'BLM Bishop Field Office', agency: 'BLM', lat: 37.6, lng: -118.4, radiusKm: 50,
    stage: 'stage2', campfiresDeveloped: 'prohibited', campfiresDispersed: 'prohibited', stoves: 'allowed_with_permit', smoking: 'prohibited',
    ...
    notes: "Signed order CAC09000-26-06 bans campfires and open flame of any kind — including in developed campgrounds; the press release reads looser than the order. Gas stoves OK with a CA Campfire Permit. Inyo, Mono and part of Alpine counties. Target shooting banned.", verifiedOn: '2026-09-26',
  },

  // ───────────── National Park Service ─────────────
  {
    id: 'nps-yosemite', statusHash: 's1:nps:none', pageFireHash: 'v5:ac8ozh:2ai', developedSitesRule: 'any_developed', noticeUpdated: '2026-08-02', boundary: { source: 'nps', match: 'Yosemite National Park' }, name: 'Yosemite NP', agency: 'NPS', lat: 37.85, lng: -119.55, radiusKm: 45,
    ...
    notes: 'Stage 2 applies below 8,000 ft. Between 8,000 and 9,600 ft: existing rings only, 100 ft from water/trail. Never above 9,600 ft. Twig stoves banned; gas/alcohol/tablet stoves OK.', verifiedOn: '2026-09-26',
  },
  {
    id: 'nps-lassen-volcanic', statusHash: 's1:nps:none', pageFireHash: 'v5:1e2wwai:nz', noticeUpdated: '2026-09-03', confidence: 'medium', confidenceNote: 'No rescission notice was published. The park says any current restriction is posted as an alert, and its alert feed has listed none since Sep 3, 2026. The visitor phone line is intermittent — email lavo_information@nps.gov to confirm.', boundary: { source: 'nps', match: 'Lassen Volcanic National Park' }, name: 'Lassen Volcanic NP', agency: 'NPS', lat: 40.5, lng: -121.45, radiusKm: 20,
    ...
    notes: 'Stage 2 (Jul 31, 2026: no wood or charcoal fires in any campground) appears lifted as of Sep 3. Standing park rules: fires only in park-provided grills and rings at established frontcountry campgrounds and day-use areas — never in the backcountry or wilderness, where only small gas or liquid-fuel stoves are allowed. Juniper Lake Campground is closed.', verifiedOn: '2026-09-26',
  },
  {
    id: 'nps-lava-beds', statusHash: 's1:nps:none', pageFireHash: 'v5:1fft04j:6n', confidence: 'medium', confidenceNote: 'Lifting is stated on the conditions page only; no formal rescission notice found. Call 530-667-8113 to confirm.', noticeUpdated: '2026-09-02', boundary: { source: 'nps', match: 'Lava Beds National Monument' }, name: 'Lava Beds NM', agency: 'NPS', lat: 41.75, lng: -121.5, radiusKm: 15,
    stage: 'none', campfiresDeveloped: 'allowed', campfiresDispersed: 'prohibited', stoves: 'allowed', smoking: 'unknown',
    effective: '2026-09-02', expires: 'until_rescinded',
    sourceUrl: 'https://www.nps.gov/labe/planyourvisit/conditions.htm',
    notes: 'Closure Order 26-001 (Jul 31, 2026) banned all wood/charcoal fires; the park conditions page now says: "Effective Sept. 2, 2026 - No fire restrictions are in place in the campground." Fires in Indian Well Campground rings only — no fires elsewhere in the monument; gas stoves OK.', verifiedOn: '2026-09-26',
  },
  {
    id: 'nps-redwood', statusHash: 's1:nps:none', pageFireHash: 'v5:kdh5mk:3f', noticeUpdated: '2026-09-10', confidence: 'low', confidenceNote: 'No 2026 fire order found on nps.gov (conditions page edited Aug 31 and Sep 2, still no order; no fire alerts posted). Status is inferred, not confirmed.', boundary: { source: 'nps', match: 'Redwood National Park' }, name: 'Redwood National & State Parks', agency: 'NPS', lat: 41.3, lng: -124.0, radiusKm: 30,
    ...
    notes: 'No 2026 park-wide order posted as of Aug 28. Campground rings normally OK; backcountry fires often banned late summer. Call 707-464-6101.', verifiedOn: '2026-09-26',
  },
  {
    id: 'nps-whiskeytown', statusHash: 's1:nps:wood charcoal burn ban', pageFireHash: 'v5:3g:1', boundary: { source: 'nps', match: 'Whiskeytown-Shasta-Trinity National Recreation Area' }, noticeUpdated: '2026-06-30', confidence: 'medium', confidenceNote: 'Posted as a park alert (in the NPS feed since about Jun 30, 2026), not as a numbered order or news release. Call 530-242-3400 to confirm.', name: 'Whiskeytown NRA', agency: 'NPS', lat: 40.63, lng: -122.6, radiusKm: 15,
    ...
    notes: 'Park alert "Wood & Charcoal Burn Ban": wood and charcoal/briquette burning is temporarily banned during the hot, dry season — campground rings and grills included. Propane grills and gas stoves OK. The alert shows at the top of every park page.', verifiedOn: '2026-09-26',
  },
  {
    id: 'nps-point-reyes', statusHash: 's1:nps:none', pageFireHash: 'v5:10b5c7y:1uj', noticeUpdated: '2026-08-28', confidence: 'medium', confidenceNote: 'Beach-fire permits are suspended day-by-day on high fire-danger days — call 415-464-5100 the morning of.', boundary: { source: 'nps', match: 'Point Reyes National Seashore' }, name: 'Point Reyes NS', agency: 'NPS', lat: 38.07, lng: -122.88, radiusKm: 20,
    ...
    notes: 'Beach fires only, with a free permit, below the high-tide line, 30 ft from vegetation, out by 10 pm; not on Drakes Beach. Suspended on any High fire-danger day — call 415-464-5100. No wood fires at backcountry camps.', verifiedOn: '2026-09-26',
  },
  ...
  {
    id: 'calfire-shu', pageFireHash: 'v5:a30jo7:p0', name: 'CAL FIRE Shasta-Trinity Unit', agency: 'CAL FIRE', lat: 40.55, lng: -122.1, radiusKm: 30,
    ...
    notes: CALFIRE_NOTES, verifiedOn: '2026-09-26',
  },
  {
    id: 'calfire-tgu', pageFireHash: 'v5:a30jo7:p0', name: 'CAL FIRE Tehama-Glenn Unit', agency: 'CAL FIRE', lat: 39.9, lng: -122.3, radiusKm: 30,
    stage: 'stage1', campfiresDeveloped: 'allowed', campfiresDispersed: 'allowed_with_permit', stoves: 'allowed_with_permit', smoking: 'unknown',
    effective: '2026-06-15', expires: 'until_rescinded', noticeUpdated: '2026-06-15', confidence: 'medium', confidenceNote: CALFIRE_CONFIDENCE_NOTE,
    sourceUrl: 'https://krcrtv.com/north-coast-news/eureka-local-news/cal-fire-suspends-burn-permits-across-the-northstate-starting-monday',
    notes: CALFIRE_NOTES, verifiedOn: '2026-09-26',
  ...
  {
    id: 'calfire-huu', pageFireHash: 'v5:a30jo7:p0', name: 'CAL FIRE Humboldt-Del Norte Unit', agency: 'CAL FIRE', lat: 40.8, lng: -123.9, radiusKm: 30,
    stage: 'stage1', campfiresDeveloped: 'allowed', campfiresDispersed: 'allowed_with_permit', stoves: 'allowed_with_permit', smoking: 'unknown',
    effective: '2026-06-15', expires: 'until_rescinded', noticeUpdated: '2026-06-15', confidence: 'medium', confidenceNote: CALFIRE_CONFIDENCE_NOTE,
    sourceUrl: 'https://krcrtv.com/north-coast-news/eureka-local-news/cal-fire-suspends-burn-permits-across-the-northstate-starting-monday',
    notes: CALFIRE_NOTES, verifiedOn: '2026-09-26',
  ...
  {
    id: 'calfire-btu', pageFireHash: 'v5:a30jo7:p0', name: 'CAL FIRE Butte Unit', agency: 'CAL FIRE', lat: 39.7, lng: -121.6, radiusKm: 30,
    stage: 'stage1', campfiresDeveloped: 'allowed', campfiresDispersed: 'allowed_with_permit', stoves: 'allowed_with_permit', smoking: 'unknown',
    effective: '2026-06-15', expires: 'until_rescinded', noticeUpdated: '2026-06-15', confidence: 'medium', confidenceNote: CALFIRE_CONFIDENCE_NOTE,
    sourceUrl: 'https://krcrtv.com/north-coast-news/eureka-local-news/cal-fire-suspends-burn-permits-across-the-northstate-starting-monday',
    notes: CALFIRE_NOTES, verifiedOn: '2026-09-26',
  ...
  {
    id: 'calfire-sku', pageFireHash: 'v5:a30jo7:p0', name: 'CAL FIRE Siskiyou Unit', agency: 'CAL FIRE', lat: 41.7, lng: -122.4, radiusKm: 30,
    stage: 'stage1', campfiresDeveloped: 'allowed', campfiresDispersed: 'allowed_with_permit', stoves: 'allowed_with_permit', smoking: 'unknown',
    effective: '2026-06-15', expires: 'until_rescinded', noticeUpdated: '2026-06-15', confidence: 'medium', confidenceNote: CALFIRE_CONFIDENCE_NOTE,
    sourceUrl: 'https://krcrtv.com/north-coast-news/eureka-local-news/cal-fire-suspends-burn-permits-across-the-northstate-starting-monday',
    notes: CALFIRE_NOTES, verifiedOn: '2026-09-26',
  ...
  {
    id: 'calfire-lnu', pageFireHash: 'v5:a2sapy:6t', name: 'CAL FIRE Sonoma-Lake-Napa Unit', agency: 'CAL FIRE', lat: 38.6, lng: -122.6, radiusKm: 30,
    stage: 'stage1', campfiresDeveloped: 'allowed', campfiresDispersed: 'allowed_with_permit', stoves: 'allowed_with_permit', smoking: 'unknown',
    effective: '2026-06-15', expires: 'until_rescinded', noticeUpdated: '2026-06-15', confidence: 'medium', confidenceNote: CALFIRE_CONFIDENCE_NOTE,
  ...
  {
    id: 'calfire-meu', pageFireHash: 'v5:1k724y7:ah', name: 'CAL FIRE Mendocino Unit', agency: 'CAL FIRE', lat: 39.3, lng: -123.4, radiusKm: 30,
    stage: 'stage1', campfiresDeveloped: 'allowed', campfiresDispersed: 'allowed_with_permit', stoves: 'allowed_with_permit', smoking: 'unknown',
  ...
  {
    id: 'calfire-neu', pageFireHash: 'v5:16vpy7x:gv', name: 'CAL FIRE Nevada-Yuba-Placer Unit', agency: 'CAL FIRE', lat: 39.2, lng: -121.1, radiusKm: 30,
    stage: 'stage1', campfiresDeveloped: 'allowed', campfiresDispersed: 'allowed_with_permit', stoves: 'allowed_with_permit', smoking: 'unknown',
    effective: '2026-06-15', expires: 'until_rescinded', noticeUpdated: '2026-06-15', confidence: 'medium', confidenceNote: CALFIRE_CONFIDENCE_NOTE,
  ...
  {
    id: 'calfire-aeu', pageFireHash: 'v5:1w2f1b1:ri', name: 'CAL FIRE Amador-El Dorado Unit', agency: 'CAL FIRE', lat: 38.6, lng: -120.9, radiusKm: 30,
    stage: 'stage1', campfiresDeveloped: 'allowed', campfiresDispersed: 'allowed_with_permit', stoves: 'allowed_with_permit', smoking: 'unknown',
    effective: '2026-06-15', expires: 'until_rescinded', noticeUpdated: '2026-06-15', confidence: 'medium', confidenceNote: CALFIRE_CONFIDENCE_NOTE,
  ...
  {
    id: 'calfire-tcu', pageFireHash: 'v5:11ypn24:m1', name: 'CAL FIRE Tuolumne-Calaveras Unit', agency: 'CAL FIRE', lat: 38.1, lng: -120.5, radiusKm: 30,
    stage: 'stage1', campfiresDeveloped: 'allowed', campfiresDispersed: 'allowed_with_permit', stoves: 'allowed_with_permit', smoking: 'unknown',
    effective: '2026-06-15', expires: 'until_rescinded', noticeUpdated: '2026-06-15', confidence: 'medium', confidenceNote: CALFIRE_CONFIDENCE_NOTE,
  ...
  {
    id: 'calfire-lmu', pageFireHash: 'v5:1xjicry:ol', name: 'CAL FIRE Lassen-Modoc Unit', agency: 'CAL FIRE', lat: 40.9, lng: -120.9, radiusKm: 30,
    stage: 'stage1', campfiresDeveloped: 'allowed', campfiresDispersed: 'allowed_with_permit', stoves: 'allowed_with_permit', smoking: 'unknown',
  ...
  // ───────────── State Parks ─────────────
  {
    id: 'csp-folsom-peninsula', pageFireHash: 'v5:v715r0:95', name: 'Folsom Lake SRA — Peninsula CG', agency: 'State Parks', lat: 38.75, lng: -121.1, radiusKm: 8,
    stage: 'stage2', campfiresDeveloped: 'prohibited', campfiresDispersed: 'prohibited', stoves: 'allowed', smoking: 'unknown',
    effective: '2026-06-10', expires: '2026-12-31',
    sourceUrl: 'https://www.parks.ca.gov/post/113',
    notes: 'Campfires, wood/charcoal cooking and liquid-fuel torches prohibited for the rest of the 2026 season. Other state parks: no statewide order — fires only in provided rings; check each park.', verifiedOn: '2026-09-26',
  },
  {
    id: 'csp-auburn', pageFireHash: 'v5:127jfoa:5c', confidence: 'low', confidenceNote: '2026 district order not located; based on the pattern of prior years.', name: 'Auburn SRA', agency: 'State Parks', lat: 38.92, lng: -121.0, radiusKm: 12,
    ...
    notes: 'Gold Fields District has banned all campfires here every summer (2025 order 690-058). 2026 order not located — assume banned until the district confirms.', verifiedOn: '2026-09-26',
  },
]
